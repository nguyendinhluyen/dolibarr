...
if ($id > 0 || !empty($ref)) {
    ...
    if ($result > 0) {
        ...
        // Libelle
        print '<tr><td>' . $langs->trans("ProductName") . '</td><td colspan="3">' . $product->label . '</td>';
        print '</tr>';
            ...
            if ($result) {
                ...
                if ($num > 0) {
                    ...
                    while ($i < $num && $i < $conf->liste_limit) {
                        ...
                        print '<td align="right">' . formatMoney(price2num($objp->total_ht)) . "</td>\n";
                ...
                print '<td align="right">' . formatMoney(price2num($total_ht)) . '</td>';
                print '<td></td>';
                print "</table>";
                print '</form>';
                print '<br>';
