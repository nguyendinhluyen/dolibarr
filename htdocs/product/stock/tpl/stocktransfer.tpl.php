...
// NanaPet - Date expired products
// Always autofill date with current date
print "<tr>";
print '<td width="20%" colspan="1" class="fieldrequired">' . $langs->trans("DateExpired") . '</td>';
print '<td width="20%" colspan="1">';
$form->select_date("", 'liv_tranfer_', '', '', '', "date_expired", 1, 1);
print '</td>';
print "</tr>";
// Label
