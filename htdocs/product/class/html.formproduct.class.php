...
class FormProduct {
    ...
    function load_measuring_units($name = 'measuring_units', $measuring_style = '', $default = '0', $adddefault = 0) {
        ...
        if ($measuring_style == 'weight') {
            ...
            $measuring_units = array(100 => 1, -9 => 1, -6 => 1, -3 => 1, 0 => 1, 88 => 1, 89 => 1, 97 => 1, 99 => 1, /* 98=>1 */);  // Liter is not used as already available with dm3
        } else if ($measuring_style == 'status') {
            $measuring_units = array(-6 => 1, -3 => 1, 0 => 1, 3 => 1);
        }
