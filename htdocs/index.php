...
if (! empty($conf->global->MAIN_MOTD))
{
    ...
    if (! empty($conf->global->MAIN_MOTD))
    {
        ...
        // NanaPet check database
        /*print "\n<!-- Start of welcome text -->\n";
        print '<table width="100%" class="notopnoleftnoright"><tr><td style="color: red">';        
        print dol_htmlentitiesbr($conf->global->MAIN_MOTD);
        print '</td></tr></table><br>';
        print "\n<!-- End of welcome text -->\n";*/        
        print "\n<!-- Start check sync data NanaPet -->\n";
        ...
        $object2 = new Societe($db, $db_nanapet);
        if($object2->checkUpdateForCustomer() == -1) {
            setEventMessage($langs->trans("WarningsCustomerDolibarr"), 'warnings');
        } else if ($object2->checkUpdateForCustomer() == 0) {
            setEventMessage($langs->trans("WarningsCustomerNanaPet"), 'warnings');
        }        
        print "\n<!-- End check sync data NanaPet -->\n";
    }
}
