...
if ($resql) {
    ...
    if ($search_total_ht != '')
        $param.='&search_total_ht=' . $search_total_ht;
    ...
    print_liste_field_titre($langs->trans('TotalMoney'), $_SERVER["PHP_SELF"], 'c.total_ht', '', $param, 'align="right"', $sortfield, $sortorder);
    $parameters = array();
    ...
    print $form->selectarray('viewstatut', $liststatus, $viewstatut, -10);
    print '</td>';
