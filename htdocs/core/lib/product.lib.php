...
function measuring_units_string($unit, $measuring_style = '') {
    ...
    if ($measuring_style == 'weight') {
        ...
        $measuring_units[0] = $langs->trans("VolumeUnitml");
        ...
        $measuring_units[100] = $langs->trans("VolumeUnitm3");
    } else if ($measuring_style == 'status') {
        $measuring_units[0] = $langs->trans("StatusUnitConHang");
        $measuring_units[3] = $langs->trans("StatusUnitHetHang");
        $measuring_units[-3] = $langs->trans("StatusUnitSapCoHang");
        $measuring_units[-6] = $langs->trans("StatusUnitDatTruoc");
    }
