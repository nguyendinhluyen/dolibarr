...
<tr <?php echo 'id="row-' . $line->id . '" ' . $bcdd[$var]; ?>>
    ...
    <!--NanaPet-->
    <td align="right" class="nowrap" id="print_detail_product"><?php $coldisplay++; ?><?php echo $line->date_expired ?></td>
    ...
    <?php } ?>
        ...
        <td align="center" id="print_detail_product"><?php $coldisplay++; ?>
    ...
    <?php } ?>
        ...
        <td align="center" id="print_detail_product"><?php $coldisplay++; ?>
            ...
            <td align="center" id="print_detail_product" class="tdlineupdown"><?php $coldisplay++; ?>
                    <?php if ($i > 0) { ?>
        ...
        <?php } else { ?>
            <td align="center" id="print_detail_product"<?php echo (empty($conf->browser->phone) ? ' class="tdlineupdown"' : ''); ?>><?php $coldisplay++; ?></td>
        <?php } ?>
    <?php } else { ?>
        <td colspan="3" id="print_detail_product"><?php $coldisplay = $coldisplay + 3; ?></td>
    <?php } ?>
