...
<tr <?php echo $bc[$var]; ?>>
    ...
    print '<input type="text" class="flat" size="7" id="date_expired" name="date_expired" value="'
    .$line->date_expired.'"';    
    print 'readonly style="background-color: #C0C0C0"></td>';
    
    print '<td align="right">'
    . '<input type="text" class="flat" size="8" id="price_ht" name="price_ht" value="' 
    .(isset($line->pu_ht)? str_replace(".","",price($line->pu_ht,0,'',0)):str_replace(".","",price($line->subprice,0,'',0))) . '"';
	...
	<?php if (($line->info_bits & 2) != 2) {
		...
		print '<input size="3" type="text" style="text-align: right" class="flat" name="qty" id="qty" value="' . $line->qty . '"';
	...
	<?php if (($line->info_bits & 2) != 2) {
		print '<input size="1" style="text-align: right" type="text" class="flat" name="remise_percent" id="remise_percent" value="' . $line->remise_percent . '"';
		if ($this->situation_counter > 1) {
            print ' readonly';
        }
		print '>%';
