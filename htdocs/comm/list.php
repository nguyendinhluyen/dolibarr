...
if ($result) {
    ...
    $param = "&amp;search_company=" . $search_company . "&amp;search_email=" . $search_email . "&amp;search_phone=" . $search_phone . "&amp;search_town=" . $search_town;
    if ($search_categ != '')
    ...
    print_liste_field_titre($langs->trans("CustomerName"), $_SERVER["PHP_SELF"], "s.nom", "", $param, "", $sortfield, $sortorder);
    ...
    print '</td>';
    print '<td class="liste_titre">';
    print '<input type="text" class="flat" name="search_email" value="' . $search_email . '" size="10">';
    print '</td>';
    print '<td class="">';
    print '<label />';
    print '</td>';
    ...
    print '<td class="liste_titre" align="center">';
    print $form->selectarray('search_status', 
            array('0' => $langs->trans('ActivityCeased'), '1' => $langs->trans('InActivity')), $search_status);
    print '</td>';
    print '<td class="liste_titre" align="right"><input class="liste_titre" type="image" src="' 
        . img_picto($langs->trans("Search"), 'search.png', '', '', 1) 
